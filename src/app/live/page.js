...
const LivePage = () => {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center bg-gray-100 rounded-md px-3 py-1.5">
              <span className="text-lg font-semibold text-gray-700">@{user.tiktok || 'username'}</span>
            </div>
          </div>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <LiveHeader onLogout={handleLogout} user={user} isConnected={isConnected} /> {/* Pass isConnected prop */}
