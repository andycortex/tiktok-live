        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-700 leading-relaxed max-w-xl">
              TapTap escucha tus transmisiones en vivo en tiktok y responde
              automáticamente por WhatsApp. Cierra ventas mientras sigues
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="stat-card">
                <div className="text-[25px] lg:text-4xl font-black text-orange-500">
                  150+
                </div>
            ...
            <div className="phone-mockup relative">
              ...
              <div className="absolute top-0 left-0 bg-white rounded-2xl shadow-2xl p-6 max-w-xs z-10">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li>
                    • Mensajes recibidos: <span className="font-bold">48</span>
                  </li>
                  <li>
                    • Respuestas enviadas: <span className="font-bold">47</span>
                  </li>
                  <li>
                    • Ventas confirmadas:{" "}
              ...
              <div className="absolute top-8 right-0 bg-white rounded-2xl shadow-2xl p-6 max-w-xs z-20">
                ...
                <ul className="space-y-1 text-sm">
                  <li>
                    • Ventas hoy: <span className="font-bold">Bs. 1,240</span>
                  </li>
                  <li>
                    • Nuevos clientes: <span className="font-bold">18</span>
                  </li>
                  <li>
                    • Productos más vendidos:{" "}
                    <span className="text-xs">
                      "Set cosmético", "Auriculares Pro"
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="absolute bottom-0 right-0 bg-white rounded-2xl shadow-2xl p-6 max-w-sm z-10">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li>
                    • 💬 TapTap: "Sí, te envío el qr de pago por WhatsApp 📱"
                  </li>
